INSERT INTO `employe` (`idEmploye`, `civilite`, `classe`, `derictor`, `email`, `fonction`, `matricule`, `nom`, `password`, `prenom`, `rib`, `id_bank`, `id_dept`, `id_grade`, `vehicule_id`,`avoir`) VALUES ('100', 'M', NULL, b'0', NULL, NULL, 'admin', 'Administrateur', 'admin', '', NULL, NULL, NULL, NULL, NULL,0);
